      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="flex justify-between items-center">
          ...
          <div class="flex gap-3">
            <Link href="/events" class="text-primary hover:underline"
              >Découvrir des événements</Link
            >
        ...
        >
          <div class="grid grid-cols-1 md:grid-cols-4 gap-6 p-6">
            ...
            <div class="relative">
              ...
              >
                <img
                  v-if="reg.event.imageUrl"
                  :src="`/uploads/${reg.event.imageUrl}`"
                  :alt="reg.event.name"
            ...
            <div class="flex flex-col justify-between gap-2">
              ...
              <button
                v-if="
                  (reg.status === 'confirmed' || reg.status === 'pending') && reg.event.isUpcoming
                "
