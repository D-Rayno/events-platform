...
<template>
  ...
  <AuthLayout>
    <div class="w-full max-w-md" v-motion :initial="{ opacity: 0, y: 20 }"
      :enter="{ opacity: 1, y: 0, transition: { duration: 400 } }">
      <!-- Header -->
      <header class="text-center mb-8">
        <h1 class="text-3xl font-bold text-sand-12 mb-2" v-motion :initial="{ opacity: 0, y: -10 }"
          :enter="{ opacity: 1, y: 0, transition: { duration: 300, delay: 100 } }">
          Bon retour parmi nous
        </h1>
        <p class="text-sand-11" v-motion :initial="{ opacity: 0, y: -10 }"
      ...
      <!-- Form Card -->
      <section class="bg-white shadow-xl rounded-2xl p-8 border border-sand-6" aria-label="Formulaire de connexion"
        ...
        <form @submit.prevent="handleSubmit" class="space-y-6" novalidate>
          ...
          <div class="flex items-center justify-between">
            <label class="flex items-center gap-2 cursor-pointer group" v-motion :initial="{ opacity: 0, x: -10 }"
          ...
          <!-- Register Link -->
          <p class="text-center text-sm text-sand-11" v-motion :initial="{ opacity: 0 }"
      ...
      <!-- Additional Info -->
      <div class="mt-6 text-center text-xs text-sand-10" v-motion :initial="{ opacity: 0 }"
