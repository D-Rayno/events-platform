      ...
      <div class="absolute bottom-8 left-0 right-0">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="flex items-end gap-4">
            ...
            <span v-if="event.isFeatured" class="px-4 py-1.5 bg-yellow-500 text-white text-sm font-bold rounded-full">
              ⭐ En vedette
            </span>
          </div>
            ...
            <div class="space-y-3">
              <div class="flex items-center gap-3">
                ...
                <div>
                  ...
                  <a :href="`mailto:${event.organizerEmail}`" class="text-primary hover:underline text-sm">
        ...
        <div class="lg:col-span-1 space-y-6">
          ...
          <div class="bg-white rounded-lg shadow-lg border border-sand-7 p-6 sticky top-8">
            ...
            <div v-else>
              ...
              <div v-else-if="event.isFull" class="bg-red-50 border border-red-200 rounded-lg p-4 text-center">
                <p class="text-red-800 font-medium">Événement complet</p>
              </div>

              <div v-else-if="event.isPast" class="bg-gray-50 border border-gray-200 rounded-lg p-4 text-center">
            ...
            <div v-if="event.requiresApproval && !isRegistered" class="mt-4 text-center">
              <p class="text-xs text-sand-10">
                ℹ️ Votre inscription nécessitera une validation
              </p>
            </div>
          </div>
