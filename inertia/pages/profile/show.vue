                        ...
                        <div class="text-center">
                            <div class="relative inline-block">
                                <div
                                    ...
                                    <img v-if="previewUrl || user.avatarUrl"
                                        :src="previewUrl || `/uploads/${user.avatarUrl}`" alt="Avatar"
                                        class="w-full h-full object-cover" />
                                    <span v-else>{{ user.firstName[0] }}{{ user.lastName[0] }}</span>
                                </div>

                                <button v-if="user.avatarUrl && !previewUrl" @click="deleteAvatar" type="button"
