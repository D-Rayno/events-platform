    ...
    <Teleport to="body">
      ...
      >
        <div
          v-if="isOpen"
          ref="dropdownRef"
          class="bg-white rounded-xl shadow-2xl border-2 border-neutral-200 overflow-hidden"
          style="z-index: 9999"
        >
          <!-- Search Input -->
          ...
          <!-- Options List -->
          <div
            class="max-h-72 overflow-y-auto scrollbar-thin scrollbar-thumb-neutral-300 scrollbar-track-neutral-100"
          >
            <div
            ...
            >
              ...
              <CheckIcon
                ...
                class="w-5 h-5 text-primary-600 animate-scale-in"
              />
            </div>
