...
<template>
    <div :class="fullscreen ? 'fixed inset-0 bg-white/80 backdrop-blur-sm' : ''"
        ...
        <div :class="[
            ...
            <!-- Spinner -->
            <div v-if="variant === 'spinner'" :class="[sizeClasses[size], loadingIndicatorClasses.spinner]" />
            ...
            <div v-if="variant === 'pulse'" class="flex gap-1">
                <div class="w-2 h-2 bg-primary-600 rounded-full animate-bounce-light"
                    :style="{ animationDelay: '0s' }" />
                <div class="w-2 h-2 bg-primary-500 rounded-full animate-bounce-light"
                    :style="{ animationDelay: '0.1s' }" />
                <div class="w-2 h-2 bg-primary-400 rounded-full animate-bounce-light"
